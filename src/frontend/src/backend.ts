...
import type { Conversation as _Conversation, Id as _Id, Message as _Message, Role as _Role, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async deleteAllConversations(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteAllConversations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteConversation(arg0: Id): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getConversation(arg0: Id): Promise<Conversation> {
        if (this.processError) {
            try {
    ...
    async sendMessage(arg0: Id, arg1: string): Promise<Message> {
        if (this.processError) {
            try {
